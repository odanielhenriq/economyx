<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-800">Contas fixas</h2>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-sm text-left">
                            ...
                            <tbody id="recurring-transactions-table" class="divide-y">
                                <tr>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            `;
            const editUrlTemplate = @json(route('recurring-transactions.edit', ['recurring_transaction' => '__ID__']));
            const deleteUrlTemplate = @json(route('recurring-transactions.destroy', ['recurring_transaction' => '__ID__']));
                            ...
                            <tr>
                                ...
                                <td class="px-3 py-2 text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <form method="POST" action="${deleteUrl}" onsubmit="return confirm('Remover esta conta fixa?');">
