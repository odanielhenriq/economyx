<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-800">Novo cartao</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                class="mt-1 w-full rounded border-gray-300 text-sm" placeholder="Ex: Nubank">
                        </div>
                        <div>
                            <label class="text-sm text-gray-600">Alias (opcional)</label>
                            <input type="text" name="alias" value="{{ old('alias') }}"
                                class="mt-1 w-full rounded border-gray-300 text-sm" placeholder="Ex: Cartao roxo">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="owner_name" value="{{ old('owner_name') }}"
                                class="mt-1 w-full rounded border-gray-300 text-sm" placeholder="Ex: Banco X">
                        </div>
                    </div>
