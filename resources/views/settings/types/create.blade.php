<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-800">Novo tipo</h2>
            <a href="{{ route('types.index') }}" class="text-sm text-indigo-600 hover:underline">
                Voltar
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-6 bg-white rounded shadow-sm border space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}"
                            class="mt-1 w-full rounded border-gray-300 text-sm" placeholder="Ex: Receita">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="color" value="{{ old('color') }}"
                            class="mt-1 w-full rounded border-gray-300 text-sm" placeholder="#f97316">
                    </div>
                </div>
