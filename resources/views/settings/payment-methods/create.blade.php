<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-800">Nova forma de pagamento</h2>
            <a href="{{ route('payment-methods.index') }}" class="text-sm text-indigo-600 hover:underline">
                Voltar
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-6 bg-white rounded shadow-sm border space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}"
                            class="mt-1 w-full rounded border-gray-300 text-sm" placeholder="Ex: Cartao de credito">
                    </div>
